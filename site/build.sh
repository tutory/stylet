...
cargo run --release -q -p stylet-cli -- build site/site.styl \
  -o _site/site.css --minify --resolve-custom-media
cp site/index.html site/site.js _site/
cp -R playground/index.html playground/playground.css playground/playground.js playground/stylet-hljs.js playground/pkg _site/playground/
